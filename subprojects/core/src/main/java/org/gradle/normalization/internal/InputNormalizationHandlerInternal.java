...
public interface InputNormalizationHandlerInternal extends InputNormalizationHandler {
    ...
    /**
     * Returns the configuration of input normalization in a configuration-cache friendly form. Input normalization cannot be further configured after this call.
     *
